(() => {
  ...
  ns.dom = {
    ...
    uiFontSelect: document.getElementById("ui-font-select"),
    ...
    buttonColorInput: document.getElementById("button-color-input"),
    buttonColorSwatch: document.getElementById("button-color-swatch"),
    buttonIconColorInput: document.getElementById("button-icon-color-input"),
    buttonIconColorSwatch: document.getElementById("button-icon-color-swatch"),
    buttonOpacityInput: document.getElementById("button-opacity-input"),
    buttonOpacityValue: document.getElementById("button-opacity-value"),
    buttonBlurInput: document.getElementById("button-blur-input"),
    buttonBlurValue: document.getElementById("button-blur-value"),
    tileBgColorInput: document.getElementById("tile-bg-color-input"),
    tileBgColorSwatch: document.getElementById("tile-bg-color-swatch"),
    tileBgOpacityInput: document.getElementById("tile-bg-opacity-input"),
    tileBgOpacityValue: document.getElementById("tile-bg-opacity-value"),
    tileBgBlurInput: document.getElementById("tile-bg-blur-input"),
    tileBgBlurValue: document.getElementById("tile-bg-blur-value"),
    gridGapInput: document.getElementById("grid-gap-input"),
    gridGapValue: document.getElementById("grid-gap-value"),
    pageMaxWidthInput: document.getElementById("page-max-width-input"),
    pageMaxWidthValue: document.getElementById("page-max-width-value"),
    pageSidePaddingInput: document.getElementById("page-side-padding-input"),
    pageSidePaddingValue: document.getElementById("page-side-padding-value"),
