(() => {
  ...
  ns.FONT_OPTIONS = ns.FONT_GROUPS.flatMap((group) => group.options);
  ...
  const BASE_DEFAULT_SETTINGS = {
    ...
    iconRadius: 25,
    buttonColor: "#111622",
    buttonIconColor: "#9aa5b1",
    buttonOpacity: 38,
    buttonBlur: 4,
    tileBackgroundColor: "#111622",
    tileBackgroundOpacity: 38,
    tileBackgroundBlur: 3,
    gridGap: 8,
    pageMaxWidth: 1200,
    pageSidePadding: 24,
    showLogo: true,
